...
| Stripe | Test and later live account owner/operator; DPA/terms; subprocessors/transfers; payout account; tax settings; portal; webhook; invoices/credit notes; retention/deletion; breach contact | Separate Wollie test account/sandbox created; test product, Prices, restricted runtime key, webhook, Customer Portal, subscription, cancellation and refund verified. Live identity, payout, tax and contractual evidence remain pending |  |
