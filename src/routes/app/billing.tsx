    ...
    >
      <header className="border-b border-zinc-200 pb-5">
        ...
        <p className="mt-1 text-sm text-zinc-500">
          Your Wollie access in one place.
        </p>
      </header>
      ...
      <Card className="max-w-3xl rounded-lg border-zinc-200 bg-white shadow-none">
        <CardContent className="grid gap-8 p-6 sm:p-8">
          <div>
            <Badge className="rounded-md bg-[var(--color-semantic-positive-soft)] text-[var(--color-semantic-positive-strong)] hover:bg-[var(--color-semantic-positive-soft)]">
              {earlyAccess
                ? "Early access"
                : billing.plan === "free"
                  ? "Free"
          ...
          {earlyAccess && (
            <div className="grid gap-2 border-t border-zinc-200 pt-6 sm:grid-cols-2">
              {[
                ...
                >
                  <Check
                    className="size-4 text-[var(--color-semantic-positive-strong)]"
                    aria-hidden="true"
                  />
                  {item}
                </p>
          ...
          <div className="flex flex-col items-start justify-between gap-4 border-t border-zinc-200 pt-6 sm:flex-row sm:items-center">
            <p className="text-xs leading-5 text-zinc-500">
              We’ll tell you before paid limits are introduced. Your data stays
              yours.
            </p>
